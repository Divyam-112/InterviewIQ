  ...
  try {
    ...
    if (!["HR", "Technical"].includes(mode)) {
      return res.status(400).json({
        message: "Mode must be either HR or Technical.",
      });
    }
    ...
    const messages = [
      {
        ...
        Ideal Answer Rules:
        - Write a model-quality answer a top candidate would give.
        - 2 to 4 clear, concise sentences.
        - Use simple, professional language.
        - Must directly answer the question with specifics.
        - Do NOT start with "I" — start with the concept or a strong verb.
        ...
        "idealAnswer": "model answer for this question"
        }
        `,
      },
      {
